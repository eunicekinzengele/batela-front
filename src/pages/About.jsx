  ...
  return (
    <div id='about' className=' w-full flex items-center h-120 bg-slate-200'>
        <div className='w-1/2 h-96	'>
          ...
          <p className='px-20 text-base text-slate-600'> servons notre communauté en leur permettant de poser des questions liées à la santé à ses confrères et consoeurs des différentes spécialités. </p>
        </div>
        <div className='w-1/2 h-96 items-center flex justify-start'>
          <Image className=' w-110 drop-shadow-2xl	' src={aboutImg} alt="about"/>
        </div>
    </div>
  )
}
